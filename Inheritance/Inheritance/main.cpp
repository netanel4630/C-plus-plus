...
int main() {
	...
	vector<Checking_Acount> check_accounts;
	check_accounts.push_back(Checking_Acount{});
	check_accounts.push_back(Checking_Acount{ "Spiderman" });
	check_accounts.push_back(Checking_Acount{ "Flash", 3000 });
	check_accounts.push_back(Checking_Acount{ "hulk", 6000 });
