...
void display(const std::vector<Checking_Acount> &accounts) {
...
void deposit(std::vector<Checking_Acount> &accounts, double amount) {
...
void withdraw(std::vector<Checking_Acount> &accounts, double amount) {
